...
pub use secrets::{
    count_client_deposits_since, count_secrets, create_secret, create_secret_from_client,
    get_secret_by_name, get_secret_version, get_secret_version_by_id, get_tags_for_secret,
    insert_secret_version, list_secrets, set_secret_tags, SecretRow, SecretVersionRow,
};
